...
| `rank_velocity` | deep-tail rank-climb radar (to depth 2000) + price momentum (6m/12m, 200SMA) — early-multibagger research watchlist; `exclude_ipos` + `max_12m_return` filters + selectable rank band / cap tier |
