...
| `rank_velocity` | deep-tail rank-climb radar (to depth 2000) + price momentum (6m/12m, 200SMA) — early-multibagger research watchlist; accumulation (early/basing) preset · off-52w-high column · ₹10cr tradeable floor · IPO + runway filters · selectable rank band/tier |
